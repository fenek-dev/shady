...
type Condition func(img image.Image, c color.NRGBA, x, y int) bool

func checkOptions(img image.Image, x, y int, opts []Condition) bool {
...
//func WithoutBreakingConsistency() Condition {
//	return func(img image.Image, c color.NRGBA, x, y int) bool {
//		bounds := img.Bounds()
